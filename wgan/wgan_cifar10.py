...
class WGAN():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if epoch % sample_interval == 0:
                ...
                self.combined.save(filepath=os.path.join(self.checkpoint_dir, "wgan_cifa10.h5"))
    ...
    def sample_images(self, epoch):
        ...
        fig, axs = plt.subplots(self.subplot_r, self.subplot_c)
        cnt = 0
        for i in range(self.subplot_r):
            for j in range(self.subplot_c):
...
if __name__ == '__main__':
    wgan = WGAN()
    wgan.train(epochs=200000, batch_size=64, sample_interval=100)
